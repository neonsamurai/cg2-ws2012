...
define([], (function() {"use strict";
        ...
        //project a point onto a circle line defined by center point and radius
        // returns 0 when p is on the circle outline
        vec2.projectPointOnCircle = function(p, cp, r) {
                var distanceVector = vec2.sub(p, cp);
                return vec2.length(distanceVector) - r;
